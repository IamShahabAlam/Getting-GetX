      ...
      color: Colors.purple,
        ...
        child: Text("Screen 5", style: TextStyle(fontSize: 25.0, color:Colors.white),),
          ...
          GetBuilder<GeneralController>(
              ...
              builder: (_) {
                          return Text("Simple No : ${_.count}");
              } ),

          ElevatedButton(
              onPressed: (){
               // Get.put(GeneralController()).simpleIncrement();     // Here we r initialising by Get.put coz we haven't initialised it in Stl widget
              ...
              child: Column(
                children: [
                  ...
                  Row( mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      GetBuilder<GeneralController>(builder: (servicesObj) { return Text("Initial Value : ${servicesObj.count}"); }),
                      Divider(height: 20 ,thickness: 20.0, color: Colors.white,),

                      GetBuilder<GeneralController>( id: "updated" , builder: (servicesObj) => Text("Updated Value : ${servicesObj.count}"))
                    ],
                  ),
