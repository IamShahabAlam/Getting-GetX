...
import 'package:getx_app/screen8.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      translations:
          Messages(), // my class which holds messages in all languages (Internationalization)
      locale: Locale("en", "US"), // setting default language
      //locale: Get.deviceLocale,   // Gets device default language
      fallbackLocale: Locale("en",
          "US"), // when doesn't find right device lang , switches to here this
      ...
      getPages: [
        ...
        GetPage(name: "/screen8", page: () => Screen8()),
